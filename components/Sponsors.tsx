    ...
    >
      ...
      <div className="container mx-auto px-6 relative z-10">
        ...
        <div className="text-center mb-12">
          ...
          <h2 className="font-display text-4xl sm:text-5xl md:text-7xl lg:text-8xl font-black uppercase text-uphoria-yellow drop-shadow-[5px_5px_0px_#000]">
        ...
        <div className="max-w-7xl mx-auto">
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 px-2">
            {sponsors.map((s) => (
              <div
                key={s.id}
                className="aspect-[3/2] w-full bg-white rounded-2xl border-4 border-black 
