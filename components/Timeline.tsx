...
const scheduleData = [
  {
    ...
    date: "Feb 14",
    events: [
      { id: "01", title: "Rockmania", type: "Battle of Bands", venue: "German Hanger" },
      { id: "02", title: "Bars Mayhem", type: "Rap", venue: "102-NLH" },
      { id: "03", title: "Kalaa Sangam", type: "Duet Dance", venue: "101-PLH" },
      { id: "04", title: "Nrityakala", type: "Group dance", venue: "C5 Stage" },
      { id: "05", title: "Chandrakala", type: "Solo Dance", venue: "102-PLH" },
      { id: "06", title: "Uphoria uncut", type: "vlog", venue: "212-A-CC" },
      { id: "07", title: "Battleground blitz", type: "BGMI", venue: "011-NCC" },
      { id: "08", title: "FIFA showdown", type: "FIFA", venue: "Bennett Hatchery" },
      { id: "09", title: "Valorant battle arena", type: "VPL", venue: "Bennett Hatchery" },
      { id: "10", title: "Tekken showdown", type: "Tekken", venue: "001-AOH" },
      { id: "11", title: "Comedy Clash", type: "Standup comedy", venue: "101-NLH" },
      { id: "12", title: "Picture perfect", type: "Photography competition", venue: "210 ACC" },
      { id: "13", title: "Reel rush", type: "reel making", venue: "211 ACC" },
      { id: "14", title: "SUPERNOVA", type: "Fashion Show", venue: "German Hanger" },
      { id: "15", title: "Graffiti Groove", type: "Graffiti", venue: "In front of LRC" },
      { id: "16", title: "Mr. and Ms. Uphoria", type: "Talent Hunt", venue: "C5 Stage" },
    ],
  },

  {
    ...
    date: "Feb 15",
    events: [
      { id: "01", title: "Aaroh", type: "Indian Solo Singing", venue: "101-NLH" },
      { id: "02", title: "Reverb", type: "Western Solo Singing", venue: "102-NLH" },
      { id: "03", title: "Mridang", type: "Instrumental solo", venue: "104-PLH" },
      { id: "04", title: "Raaga refusion", type: "Duo instrumental", venue: "102-PLH, C5 Stage" },
      { id: "05", title: "Aagaaz", type: "Street Play", venue: "Football Ground" },
      { id: "06", title: "Abhinay", type: "Mono Act", venue: "101-PLH" },
      { id: "07", title: "Bardic Battles", type: "Poetry (Eng)", venue: "010-NCC" },
      { id: "08", title: "Mehfil-e-alfaz", type: "Poetry (Hindi)", venue: "011-NCC" },
      { id: "09", title: "popcorn and Playoffs", type: "Quiz", venue: "103-PLH" },
      { id: "10", title: "Just a minute", type: "Speak for a minute", venue: "101-PLH" },
      { id: "11", title: "Uphoria uncut", type: "vlog", venue: "N/A" },
      { id: "12", title: "Rangoli Realm", type: "Rangoli", venue: "" },
      { id: "13", title: "Graffiti Groove", type: "Graffiti", venue: "In front of LRC" },
      { id: "14", title: "Tee Typography", type: "Tshirt painting", venue: "Back side B block" },
      { id: "15", title: "Valorant battle arena", type: "VPL", venue: "Bennett Hatchery" },
      { id: "16", title: "Reel Rush", type: "reel making", venue: "N/A" },
      { id: "17", title: "Picture perfect", type: "Photography competition", venue: "N/A" },
    ],
  },

  {
    ...
    date: "Feb 16",
    events: [
      { id: "01", title: "Rangmanch", type: "Stage Play", venue: "103-NLH" },
      { id: "02", title: "Improvleela", type: "Improv", venue: "104-PLH" },
      { id: "03", title: "Beat Blitz", type: "Solo Dance", venue: "101-NLH" },
      { id: "04", title: "Groove Wars", type: "Group dance", venue: "C5 Stage" },
      { id: "05", title: "Freestyle Frenzy", type: "Group Battle", venue: "Outdoor Basketball Court" },
      { id: "06", title: "Uphoria uncut", type: "Vlog", venue: "N/A" },
      { id: "07", title: "Sky High", type: "Rocket making", venue: "Cricket Ground" },
      { id: "08", title: "Doodle Dash", type: "Doodling", venue: "010-NCC" },
      { id: "09", title: "Mandala magic", type: "Mandala Art", venue: "102-NLH" },
      { id: "10", title: "Sketch Sprint", type: "Sketching", venue: "011-NCC" },
      { id: "11", title: "Pixel play", type: "Digital art (online)", venue: "N/A" },
      { id: "12", title: "Reel Rush", type: "reel making", venue: "N/A" },
      { id: "13", title: "Picture perfect", type: "Photography competition", venue: "N/A" },
    ],
  },
];
